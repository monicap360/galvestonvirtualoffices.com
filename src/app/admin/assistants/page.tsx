              ...
              <div className="flex flex-wrap items-center justify-between gap-2">
                <div>
                  ...
                  <p className="text-sm text-slate-400">
                    <a href={`mailto:${a.email}`} className="text-violet-300 hover:underline">{a.email}</a>
          ...
          {(roster ?? []).map((a) => (
            <div key={a.id} className="card p-5">
              <div className="flex items-center justify-between">
                ...
                <span className={`badge ${a.active ? "bg-violet-400/15 text-violet-300" : "bg-white/10 text-slate-300"}`}>
