  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-14">
      <header className="max-w-2xl">
        <h1 className="text-3xl font-bold text-slate-900">Websites & business platforms</h1>
      ...
      <div className="mt-10 grid gap-6 lg:grid-cols-2">
        {services.length === 0 && (
          <p className="rounded-lg bg-amber-50 px-4 py-3 text-amber-800 lg:col-span-2">
        ...
        {services.map((s) => (
          <div key={s.id} className="card flex flex-col p-6">
            ...
            <div className="mt-4 text-sm text-slate-500">Starting at <span className="text-2xl font-bold text-slate-900">{money(s.base_price_cents)}</span></div>
