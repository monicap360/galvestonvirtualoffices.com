  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 text-center">
        <p className="text-sm font-semibold uppercase tracking-[0.25em] text-fuchsia-300/80">AI Marketing Assistants</p>
      ...
      <section className="mx-auto max-w-5xl px-4 pb-4">
        ...
        <div className="card mt-8 overflow-hidden p-0">
          <div className="grid grid-cols-3 border-b border-white/10 bg-white/5 text-sm font-semibold">
            ...
            <div className="p-4 text-fuchsia-300">Galveston AI Marketing</div>
          </div>
          {compare.map((row) => (
