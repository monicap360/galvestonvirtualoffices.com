  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 text-center">
        <p className="text-sm font-semibold uppercase tracking-[0.25em] text-violet-300/80">AI Assistant</p>
      ...
      <section id="plans" className="mx-auto max-w-5xl px-4 pb-14">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          ...
          {plans.map((s, i) => (
            <div key={s.id} className={`card flex flex-col p-6 ${i === 1 ? "ring-1 ring-violet-400/50" : ""}`}>
