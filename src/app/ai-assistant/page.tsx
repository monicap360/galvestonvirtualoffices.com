  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 text-center">
        <p className="text-sm font-semibold uppercase tracking-[0.25em] text-fuchsia-300/80">AI Assistant</p>
      ...
      <section className="mx-auto max-w-5xl px-4 py-12">
        ...
        <p className="mx-auto mt-2 max-w-2xl text-center text-slate-400">
          ...
          <Link href="/virtual-assistants" className="text-fuchsia-300 hover:underline">Managed VA</Link>{" "}
        ...
        <div className="card mt-8 overflow-hidden p-0">
          <div className="grid grid-cols-3 border-b border-white/10 bg-white/5 text-sm font-semibold">
            ...
            <div className="p-4 text-fuchsia-300">AI Assistant</div>
      ...
      <section id="plans" className="mx-auto max-w-5xl px-4 pb-14">
        ...
        <div className="mt-8 grid gap-6 md:grid-cols-2">
          ...
          {plans.map((s, i) => (
            <div key={s.id} className={`card flex flex-col p-6 ${i === 1 ? "ring-1 ring-fuchsia-400/50" : ""}`}>
