  ...
  return (
    <div>
      ...
      <section className="mx-auto max-w-5xl px-4 py-16 text-center">
        <p className="text-sm font-semibold uppercase tracking-[0.25em] text-fuchsia-300/80">AI Studio</p>
      ...
      <section id="agents" className="mx-auto max-w-6xl px-4 pb-16">
        ...
        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
          {products.map((s) => (
            <div key={s.id} className="card flex flex-col p-6 transition-all hover:border-fuchsia-400/30 hover:shadow-[0_0_40px_-12px_rgba(232,121,249,0.35)]">
              <span className="inline-flex h-11 w-11 items-center justify-center rounded-xl border border-fuchsia-400/20 bg-fuchsia-400/10 text-fuchsia-300">
