  ...
  return (
    <div>
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-slate-900">Your services</h1>
      ...
      {!orders || orders.length === 0 ? (
        <div className="card mt-6 p-8 text-center text-slate-500">No services yet.</div>
      ) : (
            ...
            return (
              <div key={o.id} className="flex items-center justify-between gap-4 p-4">
                <div>
                  ...
                  <p className="text-sm text-slate-500">Started {dateLabel(o.created_at)}</p>
                </div>
                <div className="text-right">
                  {o.quoted_price_cents != null && (
                    <p className="font-semibold text-slate-900">{money(o.quoted_price_cents)}</p>
                  )}
