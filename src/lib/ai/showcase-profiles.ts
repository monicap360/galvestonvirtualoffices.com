...
export type ShowcaseAction = {
  kind: "answer" | "recommend" | "complete";
  label: string;
  prompt: string;
};

function showcaseActions(workflow: string): ShowcaseAction[] {
  return [
    { kind: "answer", label: "Answer clearly", prompt: "Answer my latest question using the business knowledge and explain the most important detail." },
    { kind: "recommend", label: "Recommend best fit", prompt: "Recommend the best-fit option for me based on this conversation and briefly explain why." },
    { kind: "complete", label: `Start ${workflow}`, prompt: `Start the ${workflow} workflow. Tell me only what information is still missing, and do not claim anything has been submitted or confirmed.` },
  ];
}
...
export const SHOWCASE_PROFILES: ShowcaseProfile[] = [
  {
    ...
    actions: showcaseActions("service request"),
  },
  {
    id: "restaurant",
    label: "Restaurant",
    ...
    actions: showcaseActions("reservation"),
  },
  {
    id: "law-office",
    label: "Law office",
    ...
    actions: showcaseActions("legal intake"),
  },
  {
    id: "medical-office",
    ...
    actions: showcaseActions("appointment request"),
  },
  {
    id: "tour-company",
    label: "Tour company",
    ...
    actions: showcaseActions("tour request"),
  },
  {
    id: "airbnb",
    ...
    actions: showcaseActions("guest request"),
  },
  {
    id: "hotel",
    label: "Hotel",
    ...
    actions: showcaseActions("hotel reservation"),
  },
  {
    id: "website-sales",
    label: "Website sales",
    ...
    actions: showcaseActions("website quote"),
  },
  {
    id: "website-support",
    ...
    actions: showcaseActions("support ticket"),
  },
];
