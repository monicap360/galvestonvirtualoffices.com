...
values
  ...
  ('00000000-0000-0000-0000-000000000001','AI Receptionist','ai-receptionist','ai_product','Answers your phone 24/7 — never miss a call.','A natural-sounding AI receptionist that answers every call day or night, books appointments, takes messages, and texts you a summary.',19900,'month','["24/7 AI phone answering","Books appointments to your calendar","Takes & transcribes messages","Instant text summaries to you","Custom greeting & call routing"]'::jsonb),
  ('00000000-0000-0000-0000-000000000001','AI Speed-to-Lead','ai-speed-to-lead','ai_product','Texts every new lead in seconds.','The first to respond wins. This agent instantly texts and emails every new lead, qualifies them, and books the call before your competitor even sees it.',17900,'month','["Instant SMS + email to new leads","Qualifies & scores each lead","Books the call automatically","Follows up until they reply","Works with your web forms"]'::jsonb),
  ('00000000-0000-0000-0000-000000000001','AI Review Manager','ai-review-manager','ai_product','More 5-star reviews, on autopilot.','Monitors Google and Yelp, drafts on-brand responses for your approval, and automatically asks happy customers for reviews.',14900,'month','["Monitors Google & Yelp","AI-drafted review responses","Auto review requests to customers","Sentiment & rating alerts","Monthly reputation report"]'::jsonb),
  ('00000000-0000-0000-0000-000000000001','AI Social Manager','ai-social-manager','ai_product','On-brand social posts, scheduled for you.','Generates on-brand posts, schedules them across your platforms, and replies to comments and DMs in your voice.',24900,'month','["On-brand post generation","Auto-scheduling across platforms","Comment & DM replies","Content calendar","Monthly performance report"]'::jsonb),
  ('00000000-0000-0000-0000-000000000001','AI Content & SEO Engine','ai-content-seo','ai_product','Blog & local SEO pages, written and published.','A content engine that researches, writes, and publishes blog posts and local SEO pages every month to grow your search traffic.',29900,'month','["Researched, on-brand articles","Local SEO landing pages","Published to your site","Keyword & topic strategy","Monthly traffic report"]'::jsonb),
  ('00000000-0000-0000-0000-000000000001','AI Knowledge Assistant','ai-knowledge','ai_product','A private AI trained on your business.','Upload your docs, SOPs, and policies — your team gets instant, accurate answers from a private AI that knows your business.',14900,'month','["Private AI trained on your docs","Instant answers for your team","Always up to date","Secure & access-controlled","Slack / web access"]'::jsonb),
  ('00000000-0000-0000-0000-000000000001','AI Dental Front Desk','ai-dental-front-desk','ai_product','A 24/7 front desk built for dental practices.','A dental-trained AI that runs your front-office admin — books and confirms appointments, verifies insurance, fills the schedule from recalls, and handles new-patient intake so your team can focus on patients.',29900,'month','["Appointment scheduling & confirmations","Insurance verification & eligibility","Recall & reactivation to fill the schedule","New-patient intake & forms","No-show reduction with reminders","Answers common patient questions 24/7"]'::jsonb),
  ('00000000-0000-0000-0000-000000000001','Full AI Employee','ai-full-employee','ai_product','Receptionist + lead follow-up + reviews in one.','Your complete AI front-office hire — answers calls, instantly follows up with every lead, books appointments, and grows your reviews. The best value for busy local businesses.',49900,'month','["Everything in AI Receptionist","Everything in AI Speed-to-Lead","Everything in AI Review Manager","One AI trained across all of it","Priority setup & support"]'::jsonb)
on conflict (tenant_id, slug) do nothing;
