...
assert.ok(actions.includes("cruisesfromgalveston.texas@gmail.com") || mail.includes("cruisesfromgalveston.texas@gmail.com"), "notification target must be Cruises From Galveston Gmail");
